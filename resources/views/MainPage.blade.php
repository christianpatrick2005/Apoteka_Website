...
<body class="bg-gray-50 text-slate-800 antialiased selection:bg-teal-500 selection:text-white">
            ...
            <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 pt-20 px-4 sm:px-6 lg:px-8">
                <main class="mt-10 mx-auto max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <span class="inline-block py-1 px-3 rounded-full bg-teal-50 text-teal-600 text-sm font-semibold mb-4 border border-teal-100">Solusi Kesehatan Terpercaya</span>
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-full shadow-md shadow-teal-500/30">
                                <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-teal-600 hover:bg-teal-700 md:py-4 md:text-lg md:px-10 transition-all">
                                    Pesan Obat
                                </a>
                            </div>
                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-slate-200 text-base font-medium rounded-full text-slate-700 bg-white hover:bg-slate-50 md:py-4 md:text-lg md:px-10 transition-all">
                                    Lihat Produk
                                </a>
                            </div>
                        </div>
            ...
            <div class="mt-10">
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-8 md:gap-y-10">
                    ...
                    <div class="relative bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                        <dt>
                            <div class="absolute flex items-center justify-center h-12 w-12 rounded-xl bg-teal-100 text-teal-600">
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid grid-cols-2 gap-y-6 gap-x-4 sm:grid-cols-2 md:grid-cols-4 lg:gap-x-8">
                <div class="group relative bg-teal-50 rounded-2xl p-6 hover:bg-teal-600 transition-colors cursor-pointer text-center flex flex-col items-center justify-center min-h-[160px]">
                    <div class="p-3 bg-white rounded-full group-hover:bg-teal-500 transition-colors mb-4">
                        <svg class="h-8 w-8 text-teal-600 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                        </svg>
                    </div>
                    <h3 class="font-semibold text-slate-900 group-hover:text-white">Obat Resep</h3>
                </div>
                ...
                <div class="group relative bg-teal-50 rounded-2xl p-6 hover:bg-teal-600 transition-colors cursor-pointer text-center flex flex-col items-center justify-center min-h-[160px]">
                    ...
                    <h3 class="font-semibold text-slate-900 group-hover:text-white">Vitamin</h3>
                </div>
                ...
                <div class="group relative bg-teal-50 rounded-2xl p-6 hover:bg-teal-600 transition-colors cursor-pointer text-center flex flex-col items-center justify-center min-h-[160px]">
                    ...
                    <h3 class="font-semibold text-slate-900 group-hover:text-white">Perawatan Tubuh</h3>
                </div>
                ...
                <div class="group relative bg-teal-50 rounded-2xl p-6 hover:bg-teal-600 transition-colors cursor-pointer text-center flex flex-col items-center justify-center min-h-[160px]">
                    ...
                    <h3 class="font-semibold text-slate-900 group-hover:text-white">P3K</h3>
                </div>
            </div>
        </div>
    </div>
